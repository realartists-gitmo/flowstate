...
struct Config {
    ...
    // Number of model replicas per device (CTranslate2 `inter_threads`): how many decodes may run
    // concurrently. 0/1 = single replica. FLOWSTATE PATCH — upstream ct2rs does not expose this.
