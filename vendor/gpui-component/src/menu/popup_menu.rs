...
use crate::scroll::{ScrollableElement, ScrollbarShow};
...
impl PopupMenuItem {
    ...
    /// Add a hover handler for a standard or custom menu item.
        ...
        F: Fn(&bool, &mut Window, &mut App) + 'static,
    {
        match &mut self {
            ...
            | PopupMenuItem::ElementItem { hover_handler, .. } => {
                *hover_handler = Some(Rc::new(handler));
            }
            _ => {}
        }
        self
