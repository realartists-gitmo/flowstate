...
pub enum CommandId {
  ...
  ExportSend,
  ToggleInvisibility,
  /// W-S4: split view (Q4-A claimed the VS Code chords).
  SplitRight,
  SplitDown,
  FocusNextPane,
  ClosePane,
  ...
  FlowToggleMarker,
  FlowToggleEraser,
  FlowToggleAnnotations,
  FlowClearAnnotations,
  FlowClearAllAnnotations,
  FlowNewSheet,
  FlowDeleteSheet,
  FlowMoveSheetLeft,
  FlowMoveSheetRight,
...
pub const COMMAND_SPECS: &[CommandSpec] = &[
  ...
  CommandSpec::new(CommandId::OpenComments, "Comment on Selection", APP, &["cmd-alt-m", "ctrl-alt-m"]),
  CommandSpec::new(CommandId::OpenHistory, "Document History", APP, &["cmd-alt-h", "ctrl-alt-h"]),
  CommandSpec::new(CommandId::ToggleTubTool, "Toggle Tub Panel", APP, &["cmd-alt-t", "ctrl-alt-t"]),
  CommandSpec::new(CommandId::FocusTubSearch, "Search the Tub", APP, &["cmd-alt-f", "ctrl-alt-f"]),
  CommandSpec::new(CommandId::SwapLeftNav, "Swap Outline/Tub Rail", APP, &["cmd-alt-l", "ctrl-alt-l"]),
  ...
  // CT-S1: the pilcrow verbs join the palette — they were ribbon-dropdown-only.
  CommandSpec::new(CommandId::CondenseSelectionPilcrows, "Condense with Pilcrows", APP, &[]),
  CommandSpec::new(CommandId::UncondensePilcrows, "Uncondense Pilcrows", APP, &[]),
  CommandSpec::new(CommandId::MarkCard, "Mark Card", APP, &["ctrl-m"]),
  CommandSpec::new(CommandId::CondensedSelection, "Shrink", APP, &["ctrl-8"]),
  CommandSpec::new(CommandId::ToggleSpeechDocument, "Toggle Speech Document", APP, &["ctrl-shift-m"]),
  CommandSpec::new(CommandId::ExportFormat, "Export Format", APP, &[]),
  CommandSpec::new(CommandId::ExportSend, "Export Send", APP, &[]),
  CommandSpec::new(CommandId::ToggleInvisibility, "Toggle Invisibility", APP, &["ctrl-shift-i"]),
  CommandSpec::new(CommandId::SplitRight, "Split Right", APP, &["ctrl-\\"]),
  CommandSpec::new(CommandId::SplitDown, "Split Down", APP, &["ctrl-shift-\\"]),
  CommandSpec::new(CommandId::FocusNextPane, "Focus Next Pane", APP, &[]),
  CommandSpec::new(CommandId::ClosePane, "Close Pane", APP, &[]),
  ...
  CommandSpec::new(CommandId::FlowAddArgument, "Flow: Add Argument", APP, &[]),
  CommandSpec::new(CommandId::FlowAddResponse, "Flow: Add Response", APP, &[]),
  CommandSpec::new(CommandId::FlowAddSiblingBelow, "Flow: Add Sibling Below", APP, &[]),
  CommandSpec::new(CommandId::FlowAddSiblingAbove, "Flow: Add Sibling Above", APP, &["alt-enter"]),
  CommandSpec::new(CommandId::FlowToggleMarker, "Flow: Marker", APP, &[]),
  CommandSpec::new(CommandId::FlowToggleEraser, "Flow: Eraser", APP, &[]),
  CommandSpec::new(CommandId::FlowToggleAnnotations, "Flow: Show/Hide Ink", APP, &[]),
  CommandSpec::new(CommandId::FlowClearAnnotations, "Flow: Clear Ink on Sheet", APP, &[]),
  CommandSpec::new(CommandId::FlowClearAllAnnotations, "Flow: Clear Ink Everywhere", APP, &[]),
  CommandSpec::new(CommandId::FlowNewSheet, "Flow: New Sheet", APP, &[]),
  CommandSpec::new(CommandId::FlowDeleteSheet, "Flow: Delete Sheet", APP, &[]),
  CommandSpec::new(CommandId::FlowMoveSheetLeft, "Flow: Move Sheet Left", APP, &[]),
  CommandSpec::new(CommandId::FlowMoveSheetRight, "Flow: Move Sheet Right", APP, &[]),
