...
mod media_tests {
  #[test]
  #[ignore = "target state: remote image edits must fail deterministically when the image id is tombstoned or out of bounds"]
  fn remote_image_edits_must_be_deterministic() {}
}