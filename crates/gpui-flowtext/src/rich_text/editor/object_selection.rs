...
mod object_selection_tests {
  #[test]
  #[ignore = "target state: remote block deletions and replacements must report repair-needed or conflict instead of silently no-oping"]
  fn remote_block_operations_must_be_deterministic() {}
}
