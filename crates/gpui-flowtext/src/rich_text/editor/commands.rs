...
impl RichTextEditor {
  ...
  pub fn undo(&mut self, cx: &mut Context<Self>) {
    ...
    let collaboration_edit = self.undo_collaboration_edit_for_history(&record);
    ...
    self.last_collaboration_edit = Some(collaboration_edit);
    self.after_history_restore(cx);
  }
  ...
  pub fn redo(&mut self, cx: &mut Context<Self>) {
    ...
    let collaboration_edit = Self::redo_collaboration_edit_for_history(&record);
