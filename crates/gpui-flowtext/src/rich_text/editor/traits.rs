...
impl Render for RichTextEditor {
  fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
    ...
    div()
      ...
      .on_action(cx.listener(Self::on_set_paragraph_style_0))
      .on_action(cx.listener(Self::on_set_paragraph_style_1))
      .on_action(cx.listener(Self::on_set_paragraph_style_2))
      .on_action(cx.listener(Self::on_set_paragraph_style_3))
      .on_action(cx.listener(Self::on_set_paragraph_style_4))
      .on_action(cx.listener(Self::on_set_paragraph_style_5))
      .on_action(cx.listener(Self::on_set_paragraph_style_6))
      .on_action(cx.listener(Self::on_toggle_underline))
      .on_action(cx.listener(Self::on_toggle_strikethrough))
      .on_action(cx.listener(Self::on_toggle_semantic_style_1))
      .on_action(cx.listener(Self::on_toggle_semantic_style_2))
      .on_action(cx.listener(Self::on_toggle_semantic_style_3))
      .on_action(cx.listener(Self::on_toggle_semantic_style_4))
      .on_action(cx.listener(Self::on_toggle_semantic_style_5))
      .on_action(cx.listener(Self::on_set_highlight_style_1))
      .on_action(cx.listener(Self::on_set_highlight_style_2))
      .on_action(cx.listener(Self::on_set_highlight_style_3))
